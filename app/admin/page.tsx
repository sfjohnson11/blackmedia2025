...
import {
  ...
  Lock, Radio, Clock, FileVideo, Trash2, Code, Edit
} from 'lucide-react';
import {
...
export default function AdminDashboard() {
  ...
  // Only fetch counts. No auth guard. No extra tables.
  useEffect(() => {
    let cancelled = false;
    (async () => {
      try {
        const [channelsRes, programsRes] = await Promise.all([
  ...
  return (
    <div>
      ...
      {/* Stats (same look you had: Channels, Programs, "Active Channels" static) */}
      ...
      <Link href="/admin/clear-cache">
        <div className="bg-gray-800 rounded-lg p-6 hover:bg-gray-700 transition-colors h-full mt-8">
